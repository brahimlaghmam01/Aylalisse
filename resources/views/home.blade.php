...
<x-layouts.public :structured-data="true">
    ...
    <section id="accueil" class="relative overflow-hidden">
        <div class="container-editorial grid items-center gap-12 pb-20 pt-14 lg:grid-cols-2 lg:gap-16 lg:pb-28 lg:pt-20">
            ...
            {{-- Visuel hero (placeholder Phase 1) --}}
            <div class="relative">
                <div class="aspect-[4/5] w-full bg-gradient-to-b from-beige to-nude/70">
    ...
    <section class="section-y">
        <div class="container-editorial">
            <x-section-heading eyebrow="Nos expériences de lissage" title="Un protocole pour chaque chevelure." />
            ...
            <div class="mt-16 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                @foreach ($experiences as $exp)
                    <article @class([
                        ...
                        <a href="{{ route('booking') }}" @class(['btn mt-6', 'btn-light' => $exp['featured'], 'btn-outline' => ! $exp['featured']])>
                            Réserver
                        </a>
                    </article>
                @endforeach
    ...
    <section id="resultats" class="section-y">
        <div class="container-editorial">
            ...
            <div
                x-data="{ pos: 50 }"
                class="relative mx-auto mt-14 max-w-4xl select-none overflow-hidden"
            >
                ...
                <input type="range" min="0" max="100" x-model="pos" aria-label="Comparateur avant après"
                       class="mt-5 w-full accent-taupe">
            </div>

            <dl class="mx-auto mt-12 grid max-w-4xl gap-8 border-t border-ink/10 pt-8 sm:grid-cols-4">
                <div><dt class="eyebrow">Type de cheveux</dt><dd class="mt-2 text-sm text-ink/75">Ondulés et volumineux</dd></div>
                <div><dt class="eyebrow">Texture</dt><dd class="mt-2 text-sm text-ink/75">Moyenne, frisottis</dd></div>
                <div><dt class="eyebrow">Type de lissage</dt><dd class="mt-2 text-sm text-ink/75">Signature Soyeux</dd></div>
                <div><dt class="eyebrow">Résultat</dt><dd class="mt-2 text-sm text-ink/75">Plus lisse, brillant, facile à coiffer</dd></div>
            </dl>
        </div>
    </section>
